    ...
    <div className="lg:flex">
      ...
      <div>
        <div>
          ...
          <div className="flex">
            <div className={`h-4 w-4 rounded-full bg-emerald-400 mt-1 flex items-center justify-center ${recommendations === undefined && 'hidden'}`}>
        ...
        <div className="mt-3">
          ...
          <div className="flex">
            <div className={`h-4 w-4 rounded-full bg-emerald-200 mt-1 flex items-center justify-center ${recommendations === undefined && 'hidden'}`}>
              <div className="bg-white rounded-full h-2 w-2"></div>
            </div>
            {recommendations
        ...
        <div className="mt-3">
          ...
          <div className="flex">
            <div className={`h-4 w-4 rounded-full bg-greyish-300/30 mt-1 flex items-center justify-center ${recommendations === undefined && 'hidden'}`}>
              <div className="bg-white rounded-full h-2 w-2"></div>
            </div>
            {recommendations
      ...
      <div className="ml-20">
        <div>
          ...
          <div className="flex">
            <div className={`h-4 w-4 rounded-full bg-reddish-500/50 mt-1 flex items-center justify-center ${recommendations === undefined && 'hidden'}`}>
              <div className="bg-white rounded-full h-2 w-2"></div>
            </div>
            {recommendations
        ...
        <div className="mt-3">
          ...
          <div className="flex">
            <div className={`h-4 w-4 rounded-full bg-reddish-500 mt-1 flex items-center justify-center ${recommendations === undefined && 'hidden'}`}>
              <div className="bg-white rounded-full h-2 w-2"></div>
            </div>
            {recommendations
